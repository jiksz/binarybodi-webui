      ...
      <Head>
          ...
          <div id="traits" className="flex flex-wrap justify-around  mx-6 py-6">
                <div className="lg:w-/2 w-/4">
                     ...
                     <p className="text-xl text-white my-6  Poppitandfinch">A syndicate Pass or Bodi Syndic is designed to be the gatekeeper of the Oracle and MPS. Every pass holder can become a member of MPS,
                     </p>
                     ...
                     <p className="text-blau Montserrat-Light text-2xl"> ⦁	Unparallel royality rewards and Loyality points.</p>
...
Token Economics
 ...
 <p class="detail  text-2xl">Name: <span class="name"> Bodi Syndic</span> </p>
 <p class="detail text-2xl">Supply:<span class="name"> 7777</span> </p>
 <p class="detail text-2xl">Mint Price:<span class="name"> 0.1ETH</span> </p>
 <p class="detail text-2xl">Blockchain<span class="name"> ETH</span> </p>
 <p class="detail text-2xl">Royality:<span class="name"> 1.5%</span> </p>
 <p class="detail text-2xl">Max Mint:<span class="name"> 7 per wallet</span> </p> 
