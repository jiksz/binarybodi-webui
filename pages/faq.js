    ...
    <div id="bodyy" className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      <div className="md:w-2/3 w-4/5 " id="about">
          ...
          <div className="flex flex-wrap  items-center mx-6   py-6 ">
            <div className="mt-6 border-b-2 py-6">
              <div className="flex flex-wrap lg:flex-nowrap justify-around items-center">
                <div className="lg:w-1/2 w-3/4">
                  <h1 className="text-5xl montserrat text-blau ">FAQ </h1>
                </div>
            ...
            <div id="traits" className="flex flex-wrap justify-around  mx-6 py-6">
              <div className="lg:w-/2 w-/4">
                ...
                <p className="text-xl text-white my-6  Poppitandfinch"> Yes, Each chapters can be physically redeemed and claimed by burning the chapter NFT.
                </p>
              </div>
            </div>
            <div id="traits" className="flex flex-wrap justify-around  mx-6 py-6">
              <div className="lg:w-/2 w-/4">
                <p className="text-blau Montserrat-Light text-2xl"> What is Binary Bodi Chapters?
                </p>
            ...
            <div id="traits" className="flex flex-wrap justify-around  mx-6 py-6">
              <div className="lg:w-/2 w-/4">
                <p className="text-blau Montserrat-Light text-2xl"> What do I need to mint Binary Bodi Chapter#1?
                </p>
                <p className="text-xl text-white my-6  Poppitandfinch"> Yes, Each chapters can be physically redeemed and claimed by burning the chapter NFT.
                </p>
              </div>
            ...
            <div id="traits" className="flex flex-wrap justify-around  mx-6 py-6">
              <div className="lg:w-/2 w-/4">
                <p className="text-blau Montserrat-Light text-2xl"> How do I read the comic?
                </p>
                <p className="text-xl text-white my-6  Poppitandfinch"> Once the Binary Bodi Chapter#1 NFT is held in your wallet, you will be able to connect to binarybodi.xyz and read your comic.
                </p>
              </div>
            </div>
            <div id="traits" className="flex flex-wrap justify-around  mx-6 py-6">
              <div className="lg:w-/2 w-/4">
                <p className="text-blau Montserrat-Light text-2xl"> How do I get Syndicate pass or access token?
                </p>
                <p className="text-xl text-white my-6  Poppitandfinch"> Syndicate Pass or Bodi pfp NFT can be minted soon from the official website and later can be brought through secondary markets.
                </p>
              </div>
            </div>
            <div id="traits" className="flex flex-wrap justify-around  mx-6 py-6">
              <div className="lg:w-/2 w-/4">
                <p className="text-blau Montserrat-Light text-2xl"> When does Binary Bodi Chapter#1 drop?
                </p>
                <p className="text-xl text-white my-6  Poppitandfinch"> June 19. 2022 Stay tuned !
                </p>
              </div>
            </div>
        ...
        <div className="flex items-center justify-between w-full border-b-2	pb-6">
          ...
          <nav className="flex flex-wrap flex-row justify-around Poppitandfinchsans">
            <a href="/home" className="text-1xl Poppitandfinchsans text-white hover:text-black m-6">Home</a>
            <button type="button" className="text-1xl Poppitandfinchsans text-white  m-6">Mint</button>
            <a href="/faq" className="text-1xl Poppitandfinchsans text-white hover:text-black m-6">FAQ</a>
            <a href="/about" className="text-1xl Poppitandfinchsans text-white hover:text-black m-6">About US</a>
