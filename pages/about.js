...
export default function Home() {
  ...
  <Head>
          ...
          <div id="traits" className="flex flex-wrap justify-around  mx-6 py-6"> 
                    <div className="mt-6 border-b-2 py-6">
                    <h1 className="text-4xl montserrat text-blau ">Our Team</h1>
                    </div></div>
                  <div className="flex flex-wrap  items-center mx-6   py-6 ">                
                  
                  <div className="lg:w-1/2 w-1/2">
                  <br></br>
                  <img className="lg:w-1/2 w-3/4" img src="images/18.png" alt="" width="100px" className="feature-image"/>
                    <h1 className="text-4xl montserrat text-blau ">Neohex</h1>
                    <p className="text-1xl text-white my-6  Poppitandfinch">
                   Founder, Developer and the Bodi. 
                  </p>
                  </div> 
                  <div className="lg:w-3/2 w-1/2"> <img className="lg:w-1/2 w-3/4" img src="images/18.png" alt="" width="100px" className="feature-image"/>
                  <h1 className="text-4xl montserrat text-blau ">Jiz</h1>
                    <p className="text-1xl text-white my-6  Poppitandfinch">
                   Female Artist & Designer.</p>
                   </div>
                   <div className="lg:w-3/2 w-1/2"> <img className="lg:w-1/2 w-3/4" img src="images/18.png" alt="" width="100px" className="feature-image"/>
                   <h1 className="text-4xl montserrat text-blau ">Jikz</h1>
                    <p className="text-1xl text-white my-6  Poppitandfinch">
                   Degen Designer</p>
                
            </div>
            <div className="lg:w-3/2 w-1/2"> <img className="lg:w-1/2 w-3/4" img src="images/18.png" alt="" width="100px" className="feature-image"/>
                   <h1 className="text-4xl montserrat text-blau ">EdMike</h1>
                    <p className="text-1xl text-white my-6  Poppitandfinch">
                   Marketing</p>
                ...
                <div id="traits" className="flex flex-wrap justify-around  mx-6 py-6"> 
                    <div className="mt-6 border-b-2 py-6">
                    <h1 className="text-4xl montserrat text-blau">About us</h1>
                    </div>
                     <p className="text-xl text-white my-6  Poppitandfinch"> The Binary Bodi team consists of fully doxxed individuals with proven track records in Crypto Sphere. We are a 
                      standalone team comprises of handfull of keyboard warrriors digging the Metaverse  for degen Yields.  We are
                      experiencing this rabbit hole since 2015, and has been contributing to the society since then. </p>
                    </div>
                    <div id="traits" className="flex flex-wrap justify-around  mx-6 py-6"> 
                    <div className="mt-6 border-b-2 py-6">
                    <h1 className="text-4xl montserrat text-blau "> Mission </h1>
                </div>
                     <p className="text-xl text-white my-6  Poppitandfinch">
                     The intellectual and cultural movement that affirms the possibility and desirability of fundamentally improving the human condition through applied reason, especially by using decentralised technologies, cryptocurrencies and NFT's to eliminate trust and greatly enhance human economical, mental, and psychological capacities</p>
                    </div>
                    <div id="traits" className="flex flex-wrap justify-around  mx-6 py-6"> 
                    <div className="mt-6 border-b-2 py-6">
                    <h1 className="text-4xl montserrat text-blau">Motivation</h1>
                    </div>
                     <p className="text-xl text-white my-6  Poppitandfinch"> At Zibit Labs, we’re NFT fanatics. We believe that NFTs represent a revolution in the art and collectibles spaces. Unfortunately, the current systems being used for NFT launches are often unfair to average users. There are several pitfalls which can give sophisticated users an edge and allow such users to extract value from both creators and other collectors.
</p>
                    </div>
